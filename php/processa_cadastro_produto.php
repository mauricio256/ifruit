<?php
 include("conexao_db.php");
     ...
     $valor_grandeza = filter_input(INPUT_POST, 'valor_grandeza', FILTER_SANITIZE_NUMBER_FLOAT);
     ...
     $valor_unitario_moeda = number_format($valor,2,".","."); 
          ...
          $conn = conecta();
          $query = "INSERT INTO `produto` (`cod_produto_pk`, `descricao`, `tamanho`, `tipo_unidade`, `valor_unidade`, `valor_unitario`, `quantidade_estoque`) 
                    VALUES (NULL, '$descricao', '$tamanho', '$tipo_unidade', '$valor_grandeza','$valor_unitario_moeda', '$quantiade_estoque');";
